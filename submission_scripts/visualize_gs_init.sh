...
RESULT_DIR="/work/courses/dslab/team20/results_gsplat_poster/nerf_init_1M_points"
...
srun python gs_splat_ckp_0.py default \
  ...
  --ckpt /work/courses/dslab/team20/results_gsplat_poster/nerf_init_1M_points/ckpts/ckpt_0_rank0.pt
